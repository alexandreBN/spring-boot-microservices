package com.microservices.alexandrebn.token.creator;
...
public class TokenCreator {
	...
	private Logger log = LoggerFactory.getLogger(TokenCreator.class);
	...
	private JWTClaimsSet createJWTClaimSet(Authentication auth, ApplicationUser applicationUser) {
		log.info("Creating the JWT Claim Set");
		...
		return new JWTClaimsSet.Builder()
			...
			.issuer("https://github.com/alexandreBN")
			.issueTime(new Date())
	...
	public String encryptToken(SignedJWT signedJWT) throws JOSEException {
		log.info("Starting the encryption token");
